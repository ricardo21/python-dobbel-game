#oefening 1: dobbelstenen

# todo verzin inzet  geld, max speelronde
# api server maken om tegen te spelen, bots
import random
import os
import time
import sys
...
def render_getallen(): 
    ...
    global ronde, wins_computer, wins_gebruiker    
